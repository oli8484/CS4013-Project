...
public class GUIConcept extends Application{
    ...
    /**
     * Menu to access other parts
     * All options a owner has
     * */
     ...
     * Shows due/overdue tax to each property
     */
     ...
     * Displays balancing statement for the property on that year
     */
     ...
     */
     ...
     /**
      * "Sub" method for managementViewTaxGUI
      * Search database to display tax due for all properties for a specific year
      */
     ...
     /**
      * "Sub" method for managementViewTaxGUI
      * Search database to display tax due for a property for all years
      */
     ...
     /**
      *  Search by eircode
      *  Shows property name, property tax, taxable amount
      */
     ...
     /**
      * Enter proposed new tax rate
      * Shows how much revenue you will get from that tax rate
      */
